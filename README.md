...
> Työntekijä-taulu sisältää tiedon tyontekijän etu- ja sukunimestä, roolista, käyttäjänimestä, salasanasta. Työntekijällä voi olla myös useita myyntitapahtumia tehtynä.
> 
